...
import com.jtljia.pump.canal.parse.driver.mysql.packets.client.ClientAuthenticationPacket;
import com.jtljia.pump.canal.parse.driver.mysql.packets.client.QuitCommandPacket;
import com.jtljia.pump.canal.parse.driver.mysql.packets.server.ErrorPacket;
import com.jtljia.pump.canal.parse.driver.mysql.packets.server.HandshakeInitializationPacket;
import com.jtljia.pump.canal.parse.driver.mysql.packets.server.Reply323Packet;
import com.jtljia.pump.canal.parse.driver.mysql.utils.MySQLPasswordEncrypter;
        ...
        if (connected.compareAndSet(true, false)) {
            ...
            if (dumping && connectionId >= 0) {
                ...
                try {
                   ...
                   logger.error("KILL DUMP " + connectionId + " failure", e);
                } finally {
                    if (connector != null) {
